...
from utils import is_http_url # this can be replaced with 'from mediawords.util.url import is_http_url'
...
class StatsExtractor:
    ...
    def _generate_iframe_soup(self, stats_url:str, referer_url:str) -> BeautifulSoup:
    ...
    def _extract_facebook_stats(self, stats_url:str, referer_url:str) -> dict:
        try:
            ...
            return {
                "error": {
                    "message": "Can't parse out the stats. Facebook might have changed their banner code."
                }
            }
        except urllib.error.URLError:
            return {
                "error": {
                    "message": "Can't connect to facebook.com"
                }
            }
    ...
    def get_stats(self, url_to_get_stats_for: str) -> dict:
        try:
            ...
            return {
                "error": {
                    "message": "Can't generate stats url for the given URL"
                }
            }
